      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-10 md:gap-16">
            ...
            <img src={tafeCentralLogo} alt="TAFE Central Region" className="h-16 md:h-20 w-auto object-contain" />
            <img src={tafeSouthLogo} alt="TAFE South" className="h-16 md:h-20 w-auto object-contain" />
            ...
            <img src={logo3} alt="Partner Logo" className="h-16 md:h-20 w-auto object-contain" />
            <img src={nawicLogo} alt="NAWIC - National Association of Women in Construction" className="h-16 md:h-20 w-auto object-contain" />
            <img src={chamberLogo} alt="Chamber of Commerce" className="h-16 md:h-20 w-auto object-contain" />
          </div>
