            ...
            <table className="w-full bg-card border border-border rounded-2xl overflow-hidden">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="p-5 text-foreground font-medium">✓ 1:1 free coaching calls with Niamh, free resume update, references, list of employers to build experience</td>
                </tr>
              </tbody>
            </table>
          </div>
