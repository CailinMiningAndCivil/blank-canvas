...
const RigidHaulTruckSchedule = () => {
  ...
  return (
    <Layout>
      ...
      {/* BOOKING WIDGET */}
      <section id="booking-widget" className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-sm uppercase tracking-wider text-primary font-semibold mb-2">05 — Lock it in</p>
            <h2 className="font-display text-3xl md:text-4xl text-foreground mb-4">Pick your date</h2>
            <p className="text-muted-foreground mb-10">
              Select an available date in the calendar below to book your Rigid Haul Truck 2-Day Initial.
            </p>
          </div>
...
export default RigidHaulTruckSchedule;
